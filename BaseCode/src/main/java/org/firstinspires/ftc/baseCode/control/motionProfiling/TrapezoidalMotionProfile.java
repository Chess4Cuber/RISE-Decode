package org.firstinspires.ftc.baseCode.control.motionProfiling;
...
public class TrapezoidalMotionProfile {
    ...
    public double trajectoryVelo = 0;
    public double initialPos = 0;
    public double initialVelo = 0;
    ...
    public double getPosProfilePower(double currPos, double targetPos){
    ...
    public double getVeloProfilePower(double currPos, double currVelo, double targetPos){
        error = targetPos - currPos;
        ...
        trajectoryVelo = currVelo - initialVelo;
        velocityError = v - trajectoryPos;


        previousTargetPos = targetPos;

        return positionError*kp + velocityError*kv + a*ka;
    }
